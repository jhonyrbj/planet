package com.planet.api.constant;

public final class MessageErrorPlanetApi {

    public static final String PLANET_API_PLANET_REQUIRED_CODE = "1";
    public static final String PLANET_API_FAILED_INTEGRATION_SWAPI_CODE = "2";
